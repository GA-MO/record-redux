...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(recordMode, 'recordMode', 'app/containers/recordRedux/actions.js');

  __REACT_HOT_LOADER__.register(play, 'play', 'app/containers/recordRedux/actions.js');

  __REACT_HOT_LOADER__.register(replayRecord, 'replayRecord', 'app/containers/recordRedux/actions.js');

  __REACT_HOT_LOADER__.register(exportJSON, 'exportJSON', 'app/containers/recordRedux/actions.js');
}();
